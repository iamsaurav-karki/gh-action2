...
import "./HelpArea.css";
// Just a simple array of objects with help items
const HELP_ITEMS = [
  {
    id: "h1",
    title: "What is Git?",
    text: "Git is a version control system, helping you to manage your code and create code snapshots.-by karki.s",
  },
  {
    id: "h2",
